...
public class RestControllerPedidos {
    ...
    public ResponseEntity<List<Pedidos>> getPedidosByCliente(@PathVariable Long idCliente) {
        List<Pedidos> pedidos = pedidosService.findByClienteIdCliente(idCliente);
